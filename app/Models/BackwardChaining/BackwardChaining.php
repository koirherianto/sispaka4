...
class BackwardChaining extends Model
{
    ...
    public function bcRuleCodes(): \Illuminate\Database\Eloquent\Relations\HasMany
    {
        return $this->hasMany(\App\Models\BackwardChaining\BcRuleCode::class, 'backward_chaining_id');
    }
