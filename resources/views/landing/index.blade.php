                    ...
                    <div class="col-md-12">
                        ...
                        <div style="height: 1px;" role="main" aria-expanded="false" class="navbar-collapse collapse navbar-collapse-centered" id="bs">
                            ...
                            <ul class="nav navbar-nav navbar-right other-navbar">
                                <li class="nav-item">
                                    <a class="nav-link btn-client-area" href="login.html"><img src="{{ URL::asset('landing/images/lock.svg') }}" alt="">Client Area</a>
...
<div class="features container-fluid">
    <div class="container">
        <div class="row rtl-row">
            <div class="col-sm-5">
                <div class="img-holder">
                    <img src="{{ URL::asset('landing/images/feature1.png') }}" alt="">
                </div>
            </div>
            <div class="col-sm-7">
        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="img-holder">
                    <img src="{{ URL::asset('landing/images/feature2.png') }}" alt="">
                </div>
            </div>
        ...
        <div class="row rtl-row">
            <div class="col-sm-5">
                <div class="img-holder">
                    <img src="{{ URL::asset('landing/images/feature3.png') }}" alt="">
                </div>
            </div>
            <div class="col-sm-7">
                <div class="feature-info">
        ...
        <div class="row custom-padding">
            <div class="col-sm-6 col-md-4">
                <div class="pricing-box">
                    ...
                    <div class="pricing-icon">
                        <div class="icon"><img src="{{ URL::asset('landing/images/server1.svg') }}" alt=""></div>
                    </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="pricing-box">
                    ...
                    <div class="pricing-icon">
                        <div class="icon"><img src="{{ URL::asset('landing/images/server4.svg') }}" alt=""></div>
                    </div>
                    <div class="pricing-details">
                        <ul>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="pricing-box">
                    ...
                    <div class="pricing-icon">
                        <div class="icon"><img src="{{ URL::asset('landing/images/server2.svg') }}" alt=""></div>
                    </div>
                    <div class="pricing-details">
                        <ul>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="pricing-box">
                    ...
                    <div class="pricing-icon">
                        <div class="icon"><img src="{{ URL::asset('landing/images/server3.svg') }}" alt=""></div>
                    </div>
                    <div class="pricing-details">
                        <ul>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="pricing-box">
                    ...
                    <div class="pricing-icon">
                        <div class="icon"><img src="{{ URL::asset('landing/images/server5.svg') }}" alt=""></div>
                    </div>
                    <div class="pricing-details">
                        <ul>
                            <li>Full root access</li>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="pricing-box">
                    ...
                    <div class="pricing-icon">
                        <div class="icon"><img src="{{ URL::asset('landing/images/server6.svg') }}" alt=""></div>
                    </div>
                    <div class="pricing-details">
                        <ul>
                            <li>User-friendly building tools</li>
    ...
    <div class="row">
        <div class="col-sm-6 hylink-holder">
            <div class="hylink-box">
                <div class="icon"><img src="{{ URL::asset('landing/images/info.svg') }}" alt=""></div>
        ...
        <div class="col-sm-6 hylink-holder">
            <div class="hylink-box">
                <div class="icon"><img src="{{ URL::asset('landing/images/chat.svg') }}" alt=""></div>
