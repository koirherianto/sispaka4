...
<div class="form-group col-sm-6 mb-2">
    ...
    {!! Form::text('slug', null, ['class' => 'form-control', 'required', 'maxlength' => 130, 'maxlength' => 130]) !!}
    @error('slug') 
        <span class="invalid-feedback d-block" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<div class="form-group col-sm-6 mb-2">
    ...
    {!! Form::text('seo_keyword', null, ['class' => 'form-control', 'maxlength' => 100, 'maxlength' => 100]) !!}
    @error('seo_keyword') 
        <span class="invalid-feedback d-block" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<div class="form-group col-sm-6 mb-2">
    ...
    {!! Form::text('seo_description', null, ['class' => 'form-control', 'maxlength' => 160, 'maxlength' => 160]) !!}
